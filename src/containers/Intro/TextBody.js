...
export const personalIntro = `
  Outside of work, I enjoy cycling, snowboarding and hanging out with friends. I recently completed a 140 mile charity bike ride to Scotland, and plan on tackling the coast-to-coast in 2021.
`;
